...
INSERT INTO user_entity (id, firstname, lastname, user_preferences_id, mobile_number, email, password_hash, registration_status) values (-10, 'Admin', 'Admin', -10, '+32492920000', 'xplorestage21+admin@gmail.com', '$2a$10$Obt2i1i.5mcc5krHb9/G4uZYk4Bfz60PJ16bjSFONqrwUHrTjaZg.', 1);
...
INSERT INTO user_entity (id, firstname, lastname, user_preferences_id, mobile_number, email, password_hash, registration_status) values (-15, 'Organization Leader', '1', -15, '+32492920000', 'xplorestage21+organizationleader1@gmail.com', '$2a$10$jC3zKO/PyOWJPkgoIRetcu60ca0piVjud7enzlmZA2w0SWzHY20W.', 1);
...
INSERT INTO user_entity (id, firstname, lastname, user_preferences_id, mobile_number, email, password_hash, registration_status) values (-16, 'Organization Leader', '2', -16, '+32492920000', 'xplorestage21+organizationleader2@gmail.com', '$2a$10$XuXtlRo3gsmenOALow0whevS3mOUvhx4vibcB.xTGBZ/miDawFXfW', 1 );
...
INSERT INTO user_entity (id, firstname, lastname, user_preferences_id, mobile_number, email, password_hash, registration_status) values (-11, 'Member', '1', -11, '+32492920000', 'xplorestage21+member1@gmail.com', '$2a$10$Oz1WPhu/jBK6PlrPJyqFUepnwAcFECuPahNabk2hGQxPMTkMIttCO', 1);
...
INSERT INTO user_entity (id, firstname, lastname, user_preferences_id, mobile_number, email, password_hash, registration_status) values (-12, 'Member', '2', -12, '+32492920000', 'xplorestage21+member2@gmail.com', '$2a$10$dOTN4PHOJsdVR.B9jSk6Ueajbkh6FhQIFpZPBFgtCV25dy3gRnVyS', 1);
...
INSERT INTO user_entity (id, firstname, lastname, user_preferences_id, mobile_number, email, password_hash, registration_status) values (-13, 'Venue', 'Manager', -13, '+32492920000', 'xplorestage21+venuemanager@gmail.com', '$2a$10$ab9K1tEbkfQxHqP5jEcEdeRTg4/aVQ8Hn4kMCEDr3NzWca7wTMkYK', 1);
...
INSERT INTO user_entity (id, firstname, lastname, user_preferences_id, mobile_number, email, password_hash, registration_status) values (-14, 'Line', 'Manager', -14, '+32492920000', 'xplorestage21+linemanager@gmail.com', '$2a$10$gQw/HyyleUqjeksfY1hHuedjfhTf51QzyeUiTFaaj2lDmpX.pAPPy', 1);
